...
from app import app  # Import the Flask app context
from models import User, Recipe  # Import User and Recipe models
from config import db  # Import the database instance
...
class TestRecipe:
    ...
    def test_has_attributes(self):
        ...
        with app.app_context():
            ...
            user.password_hash = "password123"  # Use the setter to hash the password
            db.session.add(user)
            db.session.commit()
